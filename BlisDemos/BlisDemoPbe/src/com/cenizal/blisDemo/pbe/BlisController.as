...
{
	import com.cenizal.blis.display.BlisLayer;
	import com.cenizal.blis.display.IBlisDisplayObject;
	import com.pblabs.core.PBComponent;
	
	import flash.display.BitmapData;
	
	public class BlisController extends PBComponent implements IBlisDisplayObject
	{
		...
		public function BlisController( id:String, colorId:String, w:int, h:int )
		{
			super();
			_id = id;
			_colorId = colorId;
